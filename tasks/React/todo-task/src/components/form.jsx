...
const Form = () => {
  return (
    <><form action="/search" className="max-w-[600px]  w-fit p-4 mt-10 overlay" id="search-form"> 
    <div className="relative">
      <input
        ...
        autoComplete='off'
      />
      <button type="submit" className="absolute right-0 top-0 mt-3 mr-4" id="search-btn">
